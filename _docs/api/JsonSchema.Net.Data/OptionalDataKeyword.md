...
| Name | Type | Summary |
|---|---|---|
| **Instance** | OptionalDataKeyword | Gets or sets the singleton instance of the **Json.Schema.Data.Keywords.OptionalDataKeyword** class used for keyword operations. |
