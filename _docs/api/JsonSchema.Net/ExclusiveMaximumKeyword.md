...
This keyword specifies that a numeric instance must be strictly less than the value of the keyword.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | ExclusiveMaximumKeyword | Gets the singleton instance of the **Json.Schema.Keywords.ExclusiveMaximumKeyword**. |
