...
This keyword indicates that the instance is deprecated. It has no validation effect but produces an annotation.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | DeprecatedKeyword | Gets the singleton instance of the **Json.Schema.Keywords.DeprecatedKeyword**. |
