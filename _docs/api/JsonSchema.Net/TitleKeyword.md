...
This keyword is used to provide a title for a schema. It has no validation effect but produces an annotation.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | TitleKeyword | Gets the singleton instance of the **Json.Schema.Keywords.TitleKeyword**. |
