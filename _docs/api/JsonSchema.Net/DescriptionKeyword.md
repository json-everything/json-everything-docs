...
This keyword is used to provide a human-readable description of a schema. It has no validation effect but produces an annotation.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | DescriptionKeyword | Gets the singleton instance of the **Json.Schema.Keywords.DescriptionKeyword**. |
