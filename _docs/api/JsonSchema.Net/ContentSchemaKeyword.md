...
This keyword applies a subschema to the decoded content of a string. It does not perform any validation,
...
| Name | Type | Summary |
|---|---|---|
| **Instance** | ContentSchemaKeyword | Gets the singleton instance of the **Json.Schema.Keywords.ContentSchemaKeyword**. |
