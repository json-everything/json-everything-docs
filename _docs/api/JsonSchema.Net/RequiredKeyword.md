...
This keyword specifies which properties are required on an object.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | RequiredKeyword | Gets the singleton instance of the **Json.Schema.Keywords.RequiredKeyword**. |
