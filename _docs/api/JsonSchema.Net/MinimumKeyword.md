...
This keyword specifies that a numeric instance must be greater than or equal to the value of the keyword.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | MinimumKeyword | Gets the singleton instance of the **Json.Schema.Keywords.MinimumKeyword**. |
