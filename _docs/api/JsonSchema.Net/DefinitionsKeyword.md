...
This keyword is used to define subschemas that can be referenced from elsewhere in the schema.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | DefinitionsKeyword | Gets the singleton instance of the **Json.Schema.Keywords.Draft06.DefinitionsKeyword**. |
