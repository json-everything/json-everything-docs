...
This keyword specifies the maximum number of properties in an object.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | MaxPropertiesKeyword | Gets the singleton instance of the **Json.Schema.Keywords.MaxPropertiesKeyword**. |
