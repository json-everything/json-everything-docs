...
This keyword specifies the minimum number of properties in an object.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | MinPropertiesKeyword | Gets the singleton instance of the **Json.Schema.Keywords.MinPropertiesKeyword**. |
