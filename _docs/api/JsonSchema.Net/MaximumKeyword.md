...
This keyword specifies that a numeric instance must be less than or equal to the value of the keyword.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | MaximumKeyword | Gets the singleton instance of the **Json.Schema.Keywords.MaximumKeyword**. |
