...
This keyword specifies the minimum length of a string.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | MinLengthKeyword | Gets the singleton instance of the **Json.Schema.Keywords.MinLengthKeyword**. |
