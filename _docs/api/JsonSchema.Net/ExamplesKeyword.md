...
This keyword is used to provide examples of valid instances. It has no validation effect but produces an annotation.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | ExamplesKeyword | Gets the singleton instance of the **Json.Schema.Keywords.ExamplesKeyword**. |
