...
This keyword specifies the maximum length of a string.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | MaxLengthKeyword | Gets the singleton instance of the **Json.Schema.Keywords.MaxLengthKeyword**. |
