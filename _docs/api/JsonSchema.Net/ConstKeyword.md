...
This keyword specifies that the instance must be equal to the value of the keyword.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | ConstKeyword | Gets the singleton instance of the **Json.Schema.Keywords.ConstKeyword**. |
