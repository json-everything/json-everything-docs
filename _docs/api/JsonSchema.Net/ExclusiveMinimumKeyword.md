...
This keyword specifies that a numeric instance must be strictly greater than the value of the keyword.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | ExclusiveMinimumKeyword | Gets the singleton instance of the **Json.Schema.Keywords.ExclusiveMinimumKeyword**. |
