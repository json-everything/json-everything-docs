...
This keyword specifies the minimum number of items in an array that must be valid against the `contains` schema.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | MinContainsKeyword | Gets the singleton instance of the **Json.Schema.Keywords.MinContainsKeyword**. |
