...
This keyword specifies the maximum number of items in an array.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | MaxItemsKeyword | Gets the singleton instance of the **Json.Schema.Keywords.MaxItemsKeyword**. |
