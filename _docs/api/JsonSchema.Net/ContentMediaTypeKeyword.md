...
This keyword indicates the media type of the content of a string value. It does not perform any validation,
...
| Name | Type | Summary |
|---|---|---|
| **Instance** | ContentMediaTypeKeyword | Gets the singleton instance of the **Json.Schema.Keywords.ContentMediaTypeKeyword**. |
