...
This keyword validates that a string instance matches a regular expression.

## Properties

| Name | Type | Summary |
|---|---|---|
| **Instance** | PatternKeyword | Gets the singleton instance of the **Json.Schema.Keywords.PatternKeyword**. |
